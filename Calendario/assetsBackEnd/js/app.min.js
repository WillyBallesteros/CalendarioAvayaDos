...
function _init() {
    $.Avymcs.layout = {
        ...
        fix: function() {
            ...
            if ($("body").hasClass("fixed")) $(".content-wrapper, .right-side").css("min-height", b - $(".main-footer").outerHeight());
                ...
                var e = $($.Avymcs.options.controlSidebarOptions.selector);
                "undefined" != typeof e && e.height() > d && $(".content-wrapper, .right-side").css("min-height", e.height())
            }
        },
		
        fixSidebar: function() {
            return $("body").hasClass("fixed") ? ("undefined" == typeof $.fn.slimScroll && console && console.error("Error: the fixed layout requires the slimscroll plugin!"), void($.Avymcs.options.sidebarSlimScroll && "undefined" != typeof $.fn.slimScroll && ($(".sidebar").slimScroll({
                destroy: !0
        ...
        activate: function(a) {
            var b = $.Avymcs.options.screenSizes;
            ...
            }), ($.Avymcs.options.sidebarExpandOnHover || $("body").hasClass("fixed") && $("body").hasClass("sidebar-mini")) && this.expandOnHover()
        },
        expandOnHover: function() {
            var a = this,
                b = $.Avymcs.options.screenSizes.sm - 1;
    ...
    }, $.Avymcs.controlSidebar = {
        activate: function() {
            var a = this,
                b = $.Avymcs.options.controlSidebarOptions,
                c = $(b.selector),
        ...
        selectors: $.Avymcs.options.boxWidgetOptions.boxWidgetSelectors,
        icons: $.Avymcs.options.boxWidgetOptions.boxWidgetIcons,
        activate: function() {
            var a = this;
...
if ("undefined" == typeof jQuery) throw new Error("Avymcs requires jQuery");
$.Avymcs = {}, $.Avymcs.options = {
        ...
        "undefined" != typeof AvymcsOptions && $.extend(!0, $.Avymcs.options, AvymcsOptions);
        var a = $.Avymcs.options;
        _init(), $.Avymcs.layout.activate(), $.Avymcs.tree(".sidebar"), a.enableControlSidebar && $.Avymcs.controlSidebar.activate(), a.navbarMenuSlimscroll && "undefined" != typeof $.fn.slimscroll && $(".navbar .menu").slimscroll({
            height: a.navbarMenuHeight,
            alwaysVisible: !1,
            size: a.navbarMenuSlimscrollWidth
        }).css("width", "100%"), a.sidebarPushMenu && $.Avymcs.pushMenu.activate(a.sidebarToggleSelector), a.enableBSToppltip && $("body").tooltip({
            selector: a.BSTooltipSelector
        }), a.enableBoxWidget && $.Avymcs.boxWidget.activate(), a.enableFastclick && "undefined" != typeof FastClick && FastClick.attach(document.body), a.directChat.enable && $(a.directChat.contactToggleSelector).on("click", function() {
